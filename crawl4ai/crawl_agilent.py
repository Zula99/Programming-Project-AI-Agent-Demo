...
DOMAIN      = "agilent.com"          # include all subdomains
OUTPUT_ROOT = Path("output/agilent") # new output folder
MAX_PAGES   = 10                    # start modest; raise as needed
REQUEST_GAP = 0.6
USER_AGENT  = "Mozilla/5.0 (compatible; Crawl4AI-Agilent-Tester/1.0)"
